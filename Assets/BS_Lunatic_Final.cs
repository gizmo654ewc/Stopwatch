...
public class BS_Lunatic_Final : MonoBehaviour
{
    //values
    public int health;
    ...
    void Update()
    {
        ...
        if (attacking)
        {
            ...
            {
                currWait = shotWait;
                eb1.S_Static(0, 28, 360);
                eb2.S_Static(0, 28, 360);
            }
            if (currWait2 < 0)
            {
                currWait2 = shotWait2;
                ...
                if (offset)
                {
                    eb3.S_Static(0, 42, 360);
                    eb4.S_Static(0, 42, 360);
                    offset = !offset;
                }
                else
                {
                    eb3.S_AimedCone(360, 46);
                    eb4.S_AimedCone(360, 45);
                    offset = !offset;
                }
            }
        }
